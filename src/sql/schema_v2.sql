-- schema_v2.sql
-- Complete SQLite Schema for The Forgerly v2
...
-- Track specific points in time for the whole project or specific entities
CREATE TABLE IF NOT EXISTS Snapshots (
    ID              INTEGER PRIMARY KEY,
    Timestamp       DATETIME DEFAULT CURRENT_TIMESTAMP,
    Label           TEXT,                -- e.g., "End of Draft 1", "Pre-Edit"
    Entity_Type     TEXT NOT NULL,       -- 'Chapter', 'Note', or 'Lore'
    Entity_ID       INTEGER NOT NULL,
    Content_Delta   TEXT,                -- Store the diff/delta here
    Author_Comment  TEXT
);
