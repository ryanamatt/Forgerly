...
class StoryExporter:
    ...
    def export_story(self, parent: QWidget) -> bool:
        """
        ...
        try:
            ...
            self._write_file(file_path, file_format, all_chapters_data)
    ...
    def _write_file(self, file_path: str, file_format: str, chapters_data: list[dict]) -> None:
