...
All join tables use ON DELETE CASCADE for maintenance.
...
| :---- | :---- | :---- | :---- |
| idx\_relationships\_a/b | Character\_Relationships | Character\_A/B\_ID | Fast fetching of neighbors in the social graph. |
| idx\_node\_positions\_char | Character\_Node\_Positions | Character\_ID | Instant lookups for the Graph Canvas. |
| idx\_chapter\_tags\_tag | Chapter\_Tags | Tag\_ID | Filtering chapters by a specific tag. |
| vix\_lore\_title | Lore\_Entries | Title | Speeding up auto-complete and inter-entry links. |
| idx\_lore\_category | Lore\_Entries | Category | Categorical filtering in the Lore Manager. |
| idx\_char\_locations\_char | Character\_Locations | Character\_ID | Fetching all locations tied to a character profile. |
| idx\_chapters\_title | Chapters | Title | Fast project-wide search and navigation. |
